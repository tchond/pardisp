...
namespace processing {
    ...
    private:
        ...
        */
         ...
         */
        void prepareNewShortcutEdge(const NodeID node, const EdgeID firstEdge, 
                ...
                if (_maxHops == 1)
                {
                    ...
                    for ( EdgeID eIn = firstEdge; eIn < lastEdge; eIn++ )
                    {
                        ...
                        for ( EdgeID eOut = firstEdge; eOut < lastEdge; eOut++ )
                        {
                            ...
                            if ( !foundWitness )
                            {
                                prepareNewShortcutEdge( node, firstEdge, eIn, edgeIn, eOut, edgeOut );
                            }
